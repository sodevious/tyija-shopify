...
<template>
    <button class="px-4 block absolute h-header top-0 bottom-0 left-0 z-40 md:hidden" @click="toggleMenu">
        <svg class="w-4 h-4 light:text-black">
            <use xlink:href="#menu" />
        </svg>
    </button>
    ...
    <div v-if="isMenuOpen"
        ...
        <button class="text-right block w-full pt-8 pr-8 mb-4" @click="$store.dispatch('overlays/toggleMenu')">
